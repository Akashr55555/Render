        ...
        >
          ...
          <div className="text-center mb-6">
            ...
            <p className="text-slate-600 text-xs sm:text-sm mt-1 max-w-md mx-auto">
              Unlock higher processing limits, advanced tools, OCR, AI features, and batch workflows when billing is enabled.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 mb-6 text-xs sm:text-sm text-slate-700">
            <div className="flex items-center gap-2 font-medium">
              ...
              <span>Higher file and page limits</span>
            </div>
            <div className="flex items-center gap-2 font-medium">
              <div className="w-5 h-5 rounded-full bg-emerald-100 text-emerald-600 flex items-center justify-center shrink-0">
                <Check className="w-3.5 h-3.5" />
            ...
            <div className="flex items-center gap-2 font-medium">
              ...
              <span>Priority processing when available</span>
            </div>
            <div className="flex items-center gap-2 font-medium">
              <div className="w-5 h-5 rounded-full bg-emerald-100 text-emerald-600 flex items-center justify-center shrink-0">
                <Check className="w-3.5 h-3.5" />
          ...
          <button
            ...
            disabled={loading}
            className="w-full bg-gradient-to-r from-indigo-600 via-purple-600 to-sky-500 hover:from-indigo-700 hover:to-purple-700 text-white font-bold text-base py-3.5 px-6 rounded-2xl shadow-md hover:shadow-lg transition-all flex items-center justify-center gap-2 group disabled:opacity-60 disabled:cursor-not-allowed"
          >
            <span>{loading ? 'Redirecting to secure checkout…' : 'Continue to Premium Checkout'}</span>
            {!loading && <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />}
          </button>

          <p className="text-[11px] text-center text-slate-400 mt-3">
            You'll complete payment securely on Stripe. Cancel anytime from your account menu.
          </p>
        </motion.div>
      </div>
    </AnimatePresence>
